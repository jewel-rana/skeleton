...
@section('content')
                    ...
                    <div class="col-sm-6">
                        <div class="product-details-info">
                            ...
                            <div class="product-details-action">
                                ...
                                <button class="button  button-small pink-bg">Add to cart</button>
                            </div>
                            <div class="product-details-box">
                                <p>If you want to stream TV, whilst the kids are gaming, and your partner browses the internet, plus order your shopping then we recommend the TP Link VR400 v3 AC router. This super sleek router provides two WiFi channels at 2.4Ghz and 5 Ghz you can connect wirelessly at 867Mb/s. You can also connect multiple devices at once and the router intelligence will talk to multiple devices at once with MU-MIMO - without you missing a thing PLUS Beamforming technology will direct the signal to your devices ensuring the best signal possible at all times. And for the devices you plug in there are 4 gigabit lan ports and a multifunction USB port.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Start Of Other Options Section -->
    <section>
        <div class="container">
            <div class="sub-container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title-box other-options-title">
                            <h1 class="title-text">Other options</h1>
                        </div>
                    </div>
                </div>
                <div class="row">
    ...
    <section class="empty-space-bottom">
        <div class="">
            <div class="row row-height">
                <div class="col-md-4 col-sm-6 col-height col-middle wow fadeInLeft">
                    <div class="best-deals-info">
                        <h1 class="title-text">Our best deals</h1>
                        <p>Latest High Speed Router with Faster & Even Stronger WiFi</p>
                        <a href="#" class="button pink-bg">See Internet deals</a>
                    </div>
                </div>
                <div class="col-md-8 col-sm-6 col-height col-middle wow fadeInRight">
