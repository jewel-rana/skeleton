...
@section('content')
            ...
            <div class="row">
                <div class="banner-box">
                    ...
                    <div class="banner-info">
                        <h1 class="white-color">Mobile for business</h1>
                        <h5 class="white-color">Happy with the phone and tablet you already have? Cool! Pay monthly or grab an annual contract on one of our deals.</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="empty-space">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="plan-title-box">
                        <h1 class="title-text">Create your Plan</h1>

                        <div class="plan-toggle-box">
                            <div class="plan-toggle-info">
                                <h6>Buying as a business? (Ex V.A.T)</h6>
                            </div>
                            <div class="plan-toggle">
                                <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
                                <span class="pricing-toggle-check-mark"></span>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12 plans-tab-mobile-deals">
                    <div class="plans-tab-menu">
                        <ul>
                            <li><a data-toggle="pill" href="#pt1">Data</a></li>
                            <li  class="active"><a data-toggle="pill" href="#pt2">Contract length</a></li>
                            <li><a data-toggle="pill" href="#pt3">Price</a></li>
                            <li><a data-toggle="pill" href="#pt4">EE</a></li>
                            <li><a data-toggle="pill" href="#pt5">Vodafone</a></li>
                            <li><a data-toggle="pill" href="#pt6">5g ready</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content plans-tab-content internet-deals-tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="id-more-info">
                                                ...
                                                <h5>Unlimited Calls and Unlimited SMS + 1Gb data</h5>
                        ...
                        <div id="pt2" class="tab-pane fade in active">
                            ...
                            <div class="plans-tab-info"  id="ptm03">
                                <table  class="ptmi">
                                    <tbody>
                                    <tr>
                                        <td>
                            ...
                            <div class="plans-tab-info"  id="ptm04">
                                <table  class="ptmi">
                                    <tbody>
                                    <tr>
                                        <td>
                            ...
                            <div class="plans-tab-info"  id="ptm05">
                                <table  class="ptmi">
                                    <tbody>
                                    <tr>
                                        <td>
                        ...
                        <div id="pt4" class="tab-pane fade">
                            <div class="plans-tab-info"  id="ptm00401">
                                <table  class="ptmi">
                                    <tbody>
                                    <tr>
                                        <td>
                                ...
                                <div class="ptmi-box">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="id-more-info left-border">
                                                <a href="#ptm00401" class="tab-close" data-toggle="collapse">X</a>
                                                <h4>Includes</h4>
                                                <ul>
                                                    <li>Superfast</li>
                                                    <li>Speed : 17Mbps</li>
                        ...
                        <div id="pt5" class="tab-pane fade">
                            <div class="plans-tab-info"  id="ptm00501">
                                <table  class="ptmi">
                                    <tbody>
                                    <tr>
                                        <td>
                                ...
                                <div class="ptmi-box">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="id-more-info left-border">
                                                <a href="#ptm00501" class="tab-close" data-toggle="collapse">X</a>
                                                <h4>Includes</h4>
                                                <ul>
                                                    <li>Superfast</li>
                                                    <li>Speed : 17Mbps</li>
    ...
    <section class="empty-space">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="info-box match">
                        <h2>Need more flexibility?</h2>
                        <p>We have 30 day plans on rolling contracts especially for you!</p>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="info-box match">
                        <h2>Already with Pop and want to make change to your plan?</h2>
                        <a href="#">Change my plan ></a>
                    </div>
                </div>
            </div>
        </div>
