                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" class="form-control" name="name"
                                               value="{{ old('name', $menu->name) }}" placeholder="Menu Name" required/>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="wrapper_class" class="form-control" value="{{ old('wrapper_class', $menu->wrapper_class) }}">
                                    </div>
                                </div>
                                <div class="form-group">
