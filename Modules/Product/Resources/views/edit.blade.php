                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="slug" class="form-control" name="slug"
                                               value="{{ old('slug', $product->slug) }}" placeholder="product-page-url"/>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="email-id-vertical">Description</label>
                                        <textarea id="email-id-vertical" class="form-control" rows="10" name="description"
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" id="sku" class="form-control" value="{{ old('sku', $product->sku) }}" name="sku" placeholder="SKU" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" id="price" class="form-control" name="price" value="{{ old('price', $product->price) }}" placeholder="99.99" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="number" id="upfront-price" class="form-control" name="upfront_price" value="{{ old('upfront_price', $product->upfront_price) }}" placeholder="99.99" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <div class="col-sm-3 col-form-label">
                                                            <label for="install-cost">New install cost (eg. 9.99)</label>
                                                        </div>
                                                        <div class="col-sm-9">
                                                            <input type="number" id="install-cost" class="form-control" name="install_price" value="{{ old('install_price', $product->install_price) }}" placeholder="9.99" />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select id="price_type" class="form-control" name="price_type">
                                                                ...
                                                                <option value="onetime" @if(old('price_type', $product->price_type) === 'onetime') selected @endif>{{ __('One time') }}</option>
                                                                <option value="monthly" @if(old('price_type', $product->price_type) === 'monthly') selected @endif>{{ __('Monthly') }}</option>
                                                                <option value="yearly" @if(old('price_type', $product->price_type) === 'yearly') selected @endif>{{ __('Annually') }}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="category_id" class="form-control" name="category_id">
                                    ...
                                    @foreach($category_lists as $key => $value)
                                        <option value="{{ $key }}" @if(old('category_id', $product->category_id) == $key) selected @endif>{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>

                            <div class="form-group">
                                <button type="submit" class="btn btn-primary form-control mr-1">{{ __('Create product') }}</button>
                            </div>
                        </div>
                    </div>
...
@endsection
@section('header')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/vendors/css/forms/wizard/bs-stepper.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/plugins/forms/form-wizard.css') }}">
@endsection
@section('footer')
    <script src="{{ asset('assets/admin/js/vendors/js/forms/wizard/bs-stepper.min.js') }}"></script>
